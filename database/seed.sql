...
-- ELECTRONICS (Products 1-6)
(1, 'ProMax Wireless Earbuds', 'Electronics', 'Audio', 2499.00, 'SoundWave', 
 'Premium wireless earbuds with noise cancellation, 24-hour battery life, and deep bass.', 
 3.2, 45, 500, 85, 17.00),

(2, 'UltraSlim Laptop 14"', 'Electronics', 'Laptops', 54999.00, 'TechPro', 
 'Lightweight laptop with Intel i5, 8GB RAM, 512GB SSD, Full HD display.', 
 4.1, 32, 200, 18, 9.00),

(3, 'SmartFit Watch Pro', 'Electronics', 'Wearables', 3999.00, 'FitGear', 
 'Fitness tracking smartwatch with heart rate monitor, GPS, and 7-day battery.', 
 2.8, 58, 800, 192, 24.00),

(4, '4K Action Camera', 'Electronics', 'Cameras', 8999.00, 'AdventureCam', 
 'Waterproof 4K action camera with image stabilization and wide-angle lens.', 
 3.9, 25, 300, 30, 10.00),

(5, 'PowerBank 20000mAh', 'Electronics', 'Accessories', 1299.00, 'ChargePlus', 
 'High-capacity portable charger with dual USB ports and fast charging support.', 
 4.5, 60, 1000, 40, 4.00),

(6, 'Smart Home Speaker', 'Electronics', 'Smart Home', 4499.00, 'EchoTech', 
 'Voice-controlled smart speaker with premium sound quality and home automation.', 
 3.5, 38, 450, 63, 14.00),

-- CLOTHING (Products 7-13) — These will have HIGH return rates (realistic!)
(7, 'Premium Cotton T-Shirt', 'Clothing', 'T-Shirts', 799.00, 'UrbanStyle', 
 'Soft premium cotton t-shirt available in 8 colors. Breathable fabric.', 
 3.0, 72, 1200, 312, 26.00),

(8, 'Slim Fit Denim Jeans', 'Clothing', 'Jeans', 1899.00, 'DenimCo', 
 'Classic slim fit jeans with stretch fabric for comfort. Dark wash.', 
 2.9, 55, 900, 279, 31.00),

(9, 'Running Shoes AirMax', 'Clothing', 'Footwear', 3499.00, 'SprintX', 
 'Lightweight running shoes with air cushion sole and mesh upper.', 
 3.4, 48, 600, 132, 22.00),

(10, 'Formal Blazer Suit', 'Clothing', 'Formal Wear', 4999.00, 'ClassicFit', 
 'Professional blazer with modern slim cut. Perfect for office and events.', 
 3.1, 35, 400, 100, 25.00),

(11, 'Winter Puffer Jacket', 'Clothing', 'Outerwear', 2999.00, 'WarmWear', 
 'Insulated puffer jacket with water-resistant outer shell. Ultra warm.', 
 3.8, 30, 350, 42, 12.00),

(12, 'Silk Saree - Designer', 'Clothing', 'Ethnic Wear', 5499.00, 'SilkCraft', 
 'Handwoven pure silk saree with intricate zari work and designer pallu.', 
 2.7, 42, 500, 165, 33.00),

(13, 'Leather Wallet Premium', 'Clothing', 'Accessories', 999.00, 'LeatherKing', 
 'Genuine leather wallet with RFID blocking and multiple card slots.', 
 4.2, 28, 700, 35, 5.00),

-- HOME & KITCHEN (Products 14-18)
(14, 'Non-Stick Cookware Set', 'Home & Kitchen', 'Cookware', 3999.00, 'ChefPro', 
 'Premium 5-piece non-stick cookware set with heat-resistant handles.', 
 3.3, 40, 350, 63, 18.00),

(15, 'Memory Foam Pillow', 'Home & Kitchen', 'Bedding', 1499.00, 'SleepWell', 
 'Orthopedic memory foam pillow for neck support. Cooling gel layer.', 
 3.6, 52, 600, 78, 13.00),

(16, 'LED Desk Lamp Smart', 'Home & Kitchen', 'Lighting', 1999.00, 'BrightLife', 
 'Smart LED desk lamp with adjustable brightness, color temp, and USB charging.', 
 4.3, 22, 400, 20, 5.00),

(17, 'Robot Vacuum Cleaner', 'Home & Kitchen', 'Appliances', 12999.00, 'CleanBot', 
 'Automatic robot vacuum with mapping, scheduling, and mopping feature.', 
 2.6, 48, 250, 75, 30.00),

(18, 'Air Purifier HEPA', 'Home & Kitchen', 'Appliances', 8999.00, 'PureAir', 
 'Room air purifier with true HEPA filter. Covers up to 500 sq ft.', 
 3.7, 33, 300, 36, 12.00),

-- BEAUTY & PERSONAL CARE (Products 19-20)
(19, 'Vitamin C Face Serum', 'Beauty', 'Skincare', 699.00, 'GlowNaturals', 
 'Brightening vitamin C serum with hyaluronic acid. For all skin types.', 
 3.4, 65, 900, 135, 15.00),
